Scan recent commits (since the last run, or last 24h) for violates of docs/RULES.md or for violations of the following rules. When you find them, please open a PR (using the Github CLI tools).
...
When you open a PR, please set it up in this way:
